...
namespace ProgrammersBlog.Mvc.Areas.Admin.Controllers
{
    ...
    public class UserController : BaseController
    {
        ...
        public async Task<IActionResult> Add(UserAddDto userAddDto)
        {
            ...
            {
                var uploadedImadeDtoResult = await ImageHelper.Upload(userAddDto.UserName, userAddDto.PictureFile, PictureType.User);
        ...
        public async Task<IActionResult> Update(UserUpdateDto userUpdateDto)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    var uploadedImadeDtoResult = await ImageHelper.Upload(userUpdateDto.UserName, userUpdateDto.PictureFile, PictureType.User);
        ...
        public async Task<IActionResult> PasswordChange(UserPasswordChangeDto userPasswordChangeDto)
        {
            if (ModelState.IsValid)
            {
                ...
                if (isVerified)
                {
                    ...
                    if (result.Succeeded)
                    {
                        await UserManager.UpdateSecurityStampAsync(user);//SecurityStamp-> Yakın zamanda önemli bir değeri değiştirdiğimizi belirtir.
